...
# Connect-4 dataset configuration
config_C4 = {
    "code": "connect",
    "name": "Connect4",
...
# Satellite Images dataset configuration
config_SI = {
    "code": "satimages",
    "name": "SatImages",
...
# Forest Cover dataset configuration
config_FC = {
    "code": "forest",
    "name": "ForestCover",
...
# Pen Digits dataset configuration
config_PD = {
    "code": "pendigits",
    "name": "PenDigits",
...
def load_dataset(config, standardize=True):
    if config["code"] == "mnist":
        ...
        val_dataset = TensorDataset(torch.Tensor(X_val).to(torch.float32), torch.Tensor(y_val).to(torch.int64))
